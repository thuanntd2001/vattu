...
import quanlyvattu.repositoryCN2.ChiTietPXRepositoryCN2;
import quanlyvattu.statics.InfoConnection;

@Controller
@RequestMapping(value = "quanlychitietphieuxuat/cn2")
public class QLChiTietPXControllerCN2 {
	@Autowired
	ChiTietPXRepositoryCN2 ctpxrepo;
...
//================================CHINHANH=====================================//
	...
	public String addDDHCN(ModelMap model) {
		...
		return "chinhanh2/form/add-CTPX";
	}
	...
	public String addchitietDDHCN(ModelMap model, @ModelAttribute("ct") CTPXEntity ct, HttpServletRequest request) {
		...
		if(vattu.getSoLuongTon()-ct.getSoLuong()<0)
		{
			...
			return "redirect:/quanlychitietphieuxuat/cn2/chinhanh.htm?idpx=" + idddh;
		}
		else {
...
//				nvsave = ctdhrepo.save(ct);
	...
	public String xoaNVCN1(ModelMap model, HttpServletRequest request) {
		...
		return "chinhanh2/form/xoa-CTPX";
...
//				VatTuEntity nvsave = vtrepo.findOne(id);
		...
		return "redirect:/quanlychitietphieuxuat/cn2/chinhanh.htm?idpx="+id;
	...
	//================================CONGTY=====================================//
		...
		public String addchitietDDHU(ModelMap model, @ModelAttribute("ct") CTPXEntity ct, HttpServletRequest request) {
			...
			{
				model.addAttribute("message","không đủ vật tư");
				return "redirect:/quanlychitietphieuxuat/cn2/user.htm?idpx=" + idddh;
			}
			else {
...
//					VatTuEntity nvsave = vtrepo.findOne(id);
			...
			return "redirect:/quanlychitietphieuxuat/cn2/user.htm?idpx="+id;
