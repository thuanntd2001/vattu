...
@Controller
@RequestMapping(value = "quanlyvattu/cn2")
public class QLVatTuControllerCN2 {
	@Autowired
...
//===================================CHINHANH==================================//
	...
	public String addVTCN(ModelMap model) {
		...
		return "chinhanh2/form/add-vattu";
	}
	...
	public String addVTCN1(ModelMap model, @ModelAttribute("vt") VatTuEntity vt, HttpServletRequest request) {
		...
		return "redirect:/quanlyvattu/cn2/chinhanh/add.htm";
	}
	...
	public String editVTCN1(ModelMap model, HttpServletRequest request) {
		...
		if (vt != null) {
			...
			return "redirect:quanlyvattu/cn2/chinhanh.htm";
		}

		return "chinhanh2/form/edit-vattu";
	}
	...
	public String xoaNVCN1(ModelMap model, HttpServletRequest request) {
		...
		return "chinhanh2/form/xoa-vattu";
