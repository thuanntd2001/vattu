package quanlyvattu.controller.congty;
...
@Transactional
@Controller
public class QLNhanVienHomeCongTy {

NhanVienDAO nvdao=new NhanVienDAO();
	// CONTROLLER
	@RequestMapping(value = "congty-home", method = RequestMethod.GET)
