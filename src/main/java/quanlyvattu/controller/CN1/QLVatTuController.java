...
//				VatTuEntity nvsave = vtrepo.findOne(id);
	...
	//===================================CONGTY==================================//
		...
		public String addVTU(ModelMap model) {
			VatTuEntity vt = new VatTuEntity();
			vt.setDonViTinh("kg");
			model.addAttribute("vt", vt);

			return "user/form/add-vattu";
		}

		@RequestMapping(value = "user/add", method = RequestMethod.POST)
		public String addVTU(ModelMap model, @ModelAttribute("vt") VatTuEntity vt, HttpServletRequest request) {
			...
			return "redirect:/quanlyvattu/cn1/user/add.htm";
		}
		...
		public String editVTU(ModelMap model, HttpServletRequest request) {
			...
			if (vt != null) {
				...
				System.out.print("không tồn tại vt");
				return "redirect:quanlyvattu/cn1/user.htm";
			}

			return "user/form/edit-vattu";
		}

		@RequestMapping(value = "user/edit", method = RequestMethod.POST)
		public String editVTU(ModelMap model, @ModelAttribute("vt") VatTuEntity vt, HttpServletRequest request) {
		...
		public String xoaNVU(ModelMap model, HttpServletRequest request) {
			...
			return "user/form/xoa-vattu";

		}

		@RequestMapping(value = "user/xoa", method = RequestMethod.POST)
		public String xoaNVUS(ModelMap model, HttpServletRequest request) {
