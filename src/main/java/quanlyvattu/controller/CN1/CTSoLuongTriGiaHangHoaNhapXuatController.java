...
//		return "chinhanh/ctsoluongtrigiahanghoanhapxuat";
	...
	public String getPNCN1(ModelMap model, HttpServletRequest request) {
		...
		String sql = "EXEC	[dbo].[sp_ChiTietSoLuongTriGiaHangHoaNhapXuat]\r\n" + 
				...
				"		@DATEFROM = ?,\r\n" + 
				"		@DATETO = ?";
		List<CTSLHHXNModel> ctpn=dao.queryPM(InfoConnection.getUserNamePM(), InfoConnection.getPassWordPM(), sql, new CTSLHHXNMapper(),"CHINHANH" ,"NHAP",tungay,denngay );
//		System.out.println(ctxn.get(0).getThangNam());
...
//		System.out.println(ctxn.get(0).getTenVT());
	...
	public String getPXCN12(ModelMap model, HttpServletRequest request) {
		...
		String sql = "EXEC	[dbo].[sp_ChiTietSoLuongTriGiaHangHoaNhapXuat]\r\n" + 
				...
				"		@DATEFROM = ?,\r\n" + 
				"		@DATETO = ?";
		List<CTSLHHXNModel> ctpx=dao.queryPM(InfoConnection.getUserNamePM(), InfoConnection.getPassWordPM(), sql, new CTSLHHXNMapper(),"CHINHANH" ,"XUAT",tungay,denngay );
