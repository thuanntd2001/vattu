		...
		<nav>
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a
					href="quanlykho/cn2/congty.htm">Kho</a></li>
							...
							<tbody>
								<c:forEach items="${ddhs }" var="k">
									<tr>
										...
										<td>${k.kho.maKho}</td>
										<td><a
											href="quanlychitietdondathang/cn2/congty.htm?idddh=${k.maSoDDH}"
											class="fa fa-eye"><br>Chi Tiết DDH<br> </a> <a
											href="quanlyphieunhap/cn2/congty.htm?idDDH=${k.maSoDDH}&&idkho=${k.kho.maKho}"
