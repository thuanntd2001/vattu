							...
							<tbody>
								<c:forEach items="${ddhs }" var="k">
									<tr>
										...
										<td>${k.kho.maKho}</td>
										<td><a
											href="quanlychitietdondathang/cn2/chinhanh.htm?idddh=${k.maSoDDH}"
											class="fa fa-eye"><br>Chi Tiết DDH<br> </a> <a
											href="quanlyphieunhap/cn2/chinhanh.htm?idDDH=${k.maSoDDH}&&idkho=${k.kho.maKho}"
											class="fa fa-indent"> <br>Xem phiếu nhập<br></a>
										<td><a
											href="quanlydondathang/cn2/chinhanh/edit.htm?id=${k.maSoDDH}"
											class="fa fa-pencil-square-o"></a> <a
											href="quanlydondathang/cn2/chinhanh/xoa.htm?id=${k.maSoDDH}"
											class="fa fa-times-circle"></a></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
						<a href="quanlydondathang/cn2/chinhanh/add.htm" class="fa fa-plus"></a>
					</div>
				</div>
