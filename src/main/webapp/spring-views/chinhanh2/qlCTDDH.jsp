	...
	<div class="pagetitle">
		...
		<nav>
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="quanlydondathang/cn2/chinhanh.htm">Đơn hàng</a></li>
			...
			<div class="col-lg-10">
				...
				<div class="card">
					<div class="card-body">
							...
							<tbody>
								...
								<c:forEach items="${ddhs }" var="k">
									<tr>
										...
										<td>${k.donGia}</td>
										<td><a href="quanlychitietdondathang/cn2/chinhanh/xoa.htm?id=${k.datHang.maSoDDH}&vt=${k.vatTu.maVT}" class="fa fa-times-circle"></a></td>
									</tr>
								</c:forEach>
						...
						<a href="quanlychitietdondathang/cn2/chinhanh/add.htm"
							class="fa fa-plus"></a>
