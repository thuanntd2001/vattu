							...
							<tbody>
								...
								<c:forEach items="${ddhs }" var="k">
									<tr>
										...
										<td>${k.kho.maKho}</td>
										<td><a href="quanlychitietphieuxuat/cn2/chinhanh.htm?idpx=${k.maPX}" class="fa fa-eye"></a></td>
										<td><a
											href="quanlyphieuxuat/cn2/chinhanh/edit.htm?id=${k.maPX}"
											class="fa fa-pencil-square-o"></a> <a
											href="quanlyphieuxuat/cn2/chinhanh/xoa.htm?id=${k.maPX}"
											class="fa fa-times-circle"></a></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
						<a href="quanlyphieuxuat/cn2/chinhanh/add.htm" class="fa fa-plus"></a>
					</div>
				</div>
