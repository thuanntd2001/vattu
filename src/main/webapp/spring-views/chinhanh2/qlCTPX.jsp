			...
			<div class="col-lg-12">
				<div class="card">
					<div class="card-body">
							...
							<tbody>
								...
								<c:forEach items="${ddhs }" var="k">
									<tr>
										...
										<td><a href="quanlychitietphieuxuat/cn2/chinhanh/xoa.htm?id=${k.phieuXuat.maPX}&vt=${k.vatTu.maVT}" class="fa fa-times-circle"></a>
									</tr>
								</c:forEach>
						...
						<a href="quanlychitietphieuxuat/cn2/chinhanh/add.htm" class="fa fa-plus"></a>
					</div>
				</div>
