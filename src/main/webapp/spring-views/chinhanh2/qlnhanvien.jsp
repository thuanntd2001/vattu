			...
			<div class="col-lg-12">
				<div class="card">
					<div class="card-body">
							...
							<tbody>
								<c:forEach items="${nvs }" var="nv">
									<tr>
										...
										<td>${nv.ngaySinh}</td>
										<td>${nv.luong}VND</td>
										<td><a href="quanlynhanvien/cn2/chinhanh/edit.htm?id=${nv.maNV} "
											class="fa fa-pencil-square-o"></a> <a href="quanlynhanvien/cn2/chinhanh/xoa.htm?id=${nv.maNV} "
						...
						<a href="quanlynhanvien/cn2/chinhanh/add.htm" class="fa fa-plus"></a>
					</div>
				</div>
