			...
			<div class="col-lg-12">
				<div class="card">
					<div class="card-body">
							...
							<tbody>
								...
								<c:forEach items="${ks }" var="k">
									<tr>
										...
										<td><a
											href="quanlydondathang/cn2/chinhanh.htm?idkho=${k.maKho}"
											class="fa fa-file-text-o"> <br>Đơn đặt hàng
										</a> <a href="quanlyphieuxuat/cn2/chinhanh.htm?idkho=${k.maKho}"
											class="fa fa-outdent"><br>Phiếu xuất</a></td>

										<td><a
											href="quanlykho/cn2/chinhanh/edit.htm?id=${k.maKho}"
											class="fa fa-pencil-square-o"></a> <a
											href="quanlykho/cn2/chinhanh/xoa.htm?id=${k.maKho}"
						...
						<a href="quanlykho/cn2/chinhanh/add.htm" class="fa fa-plus"></a>
					</div>
				</div>
			</div>
		</div>
