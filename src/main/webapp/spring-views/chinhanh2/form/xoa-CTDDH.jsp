	...
	<div class="pagetitle">
		...
		<nav>
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a
					href="quanlychitietdondathang/cn2/chinhanh.htm">Chi tiết đơn
						đặt hàng</a></li>
	...
	<section class="section">
		<div class="row">
			<div class="col-lg-5">
				...
				<div class="card">
					<div class="card-body">
						<h5 class="card-title">Xóa chi tiết đơn đặt hàng</h5>
						${message} ${message}

						<form
							action="quanlychitietdondathang/cn2/chinhanh/xoa.htm?id=${id }&&vt=${vt}"
							method="post" class="row g-3">
							<div class="col-md-12" style="">
								<label for="inputEmail5" class="form-label">Bạn có đồng
									ý xoá chi tiết đơn đặt ${id }</label>
							</div>
