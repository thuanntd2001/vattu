			...
			<div class="col-lg-12">
				<div class="card">
					<div class="card-body">
							...
							<tbody>
								...
								<c:forEach items="${vts }" var="nv">
									<tr>
										...
										<td><a href="quanlyvattu/cn2/chinhanh/edit.htm?id=${nv.maVT}"
											class="fa fa-pencil-square-o"></a> <a href="quanlyvattu/cn2/chinhanh/xoa.htm?id=${nv.maVT}"
											class="fa fa-times-circle"></a></td>
									</tr>
								</c:forEach>
							</tbody>
						...
						<a href="quanlyvattu/cn2/chinhanh/add.htm" class="fa fa-plus"></a>
					</div>
				</div>
