							...
							<tbody>
								<c:forEach items="${ddhs }" var="k">
									<tr>
										...
										<td>${k.kho.maKho}</td>
 										<td><a href="quanlychitietphieunhap/cn2/user.htm?idpn=${k.maPN}" class="fa fa-eye"></a></td>
										<td> <a
											href="quanlyphieunhap/cn2/user/xoa.htm?id=${k.maPN}"
											class="fa fa-times-circle"></a></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
						<a href="quanlyphieunhap/cn2/user/add.htm" class="fa fa-plus"></a>
					</div>
				</div>
