			...
			<div class="col-lg-10">
				...
				<div class="card">
					<div class="card-body">
							...
							<tbody>
								...
								<c:forEach items="${ddhs }" var="k">
									<tr>
										...
										<td>${k.donGia}</td>
										<td><a href="quanlychitietdondathang/cn2/user/xoa.htm?id=${k.datHang.maSoDDH}&vt=${k.vatTu.maVT}" class="fa fa-times-circle"></a></td>
									</tr>
								</c:forEach>
						...
						<a href="quanlychitietdondathang/cn2/user/add.htm"
							class="fa fa-plus"></a>
