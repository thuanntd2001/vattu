	...
	<div class="pagetitle">
		...
		<nav>
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a
					href="quanlyphieunhap/cn2/user.htm">Phiếu nhập</a></li>
							...
							<tbody>
								...
								<c:forEach items="${ddhs }" var="k">
									<tr>
										...
										<td><a href="quanlychitietphieunhap/cn2/user/xoa.htm?id=${k.phieuNhap.maPN}&&vt=${k.vatTu.maVT}" class="fa fa-times-circle"></a>
									</tr>
								</c:forEach>

							</tbody>
						</table>
						<a href="quanlychitietphieunhap/cn2/user/add.htm"
							class="fa fa-plus"></a>
					</div>
				</div>
