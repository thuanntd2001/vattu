							...
							<tbody>
								...
								<c:forEach items="${ddhs }" var="k">
									<tr>
										...
										<td>${k.kho.maKho}</td>
										<td><a href="quanlychitietphieuxuat/cn1/user.htm?idpx=${k.maPX}" class="fa fa-eye"></a></td>
										<td><a
											href="quanlyphieuxuat/cn1/user/edit.htm?id=${k.maPX}"
											class="fa fa-pencil-square-o"></a> <a
											href="quanlyphieuxuat/cn1/user/xoa.htm?id=${k.maPX}"
											class="fa fa-times-circle"></a></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
						<a href="quanlyphieuxuat/cn1/user/add.htm" class="fa fa-plus"></a>
					</div>
				</div>
