...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
	...
	<div class="collapse navbar-collapse" id="navbarNavDropdown" style="text-align:right !important;">
		<ul class="navbar-nav">
			...
			<li class="nav-item"><a class="nav-link" href="quanlynhanvien/cn2/congty.htm">Chuyển chi nhánh</a></li>
			<li class="nav-item"><a class="nav-link" href="xembaocao/cn1/congty.htm">Xem báo
					cáo</a></li>
			<li class="nav-item"><a class="nav-link" href="taologin/cn1/congty.htm">Tạo Login cho hệ thống</a></li>
